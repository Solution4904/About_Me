...
import com.solution.about_me.feature.QuestionActivity
import com.solution.about_me.feature.TitleActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun ButtonEvents() {
        ...
        findViewById<Button>(R.id.BBB).setOnClickListener { _ -> startActivity(Intent(this, QuestionActivity::class.java)) }
